...
CreateThread(function()
	...
	if GetConvar('voice_useNativeAudio', 'false') == 'false' and GetConvar('voice_use3dAudio', 'false') == 'false' and GetConvar('voice_use2dAudio', 'false') == 'false' then
		...
		--print('[^4PMA-VOICE^0] Aucun convar n\'a été détecté pour le mode vocal, la valeur par défaut est la suivante \'setr voice_useNativeAudio true\' ou \'setr voice_useSendingRangeOnly true\'')
