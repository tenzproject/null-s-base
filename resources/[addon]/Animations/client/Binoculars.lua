...
if Config.Animations.BinocularsEnabled then
    ...
    function UseBinocular()
        ...
        if IsUsingBinoculars then
            ...
            local keyList = nil
            if Config.Animations.AllowVisionsToggling then
                keyList = {
            ...
            while IsUsingBinoculars and not IsEntityDead(PlayerPedId()) and not IsPedSittingInAnyVehicle(PlayerPedId()) do
                ...
                if IsControlJustPressed(0, 19) and Config.Animations.AllowVisionsToggling then
