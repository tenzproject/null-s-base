...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
	...
	Cfg.voiceModes = {
		{1.0, "Chuchotement"}, -- Whisper speech distance in gta distance units
		{2.3, "Parler"}, -- Normal speech distance in gta distance units
		{5.0, "Crier"} -- Shout speech distance in gta distance units
	}
else
	Cfg.voiceModes = {
		{3.0, "Chucotement"}, -- Whisper speech distance in gta distance units
