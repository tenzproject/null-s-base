...
Config.Cameras.HideRadar = true -- Controls if the minimap will be disabled when in a camera.
Config.Cameras.HideHUD = false -- Controls if the HUD will be disabled when in a camera. (Reference Utils.ToggleHUD() in Utils.lua)

Config.Cameras.UseAces = true -- Controls if you're using default permissions or not

Config.Cameras.ShowNoPerms = true -- Controls whether or not to display the no permissions error

Config.Cameras.Cameras = { -- All of the logged cameras
    {location = vector4(659.265503, -104.717674, 70.359962, 183.1629486084), canRotate = true, cameraType = "blackwhite", type = "General Stores", name = "Los Santos FreeWay", camera = 1},
    {location = vector4(711.031128, -22.286379, 79.607407, 195.41459655762), canRotate = true, cameraType = "blackwhite", type = "General Stores", name = "Los Santos FreeWay", camera = 2},
    {location = vector4(935.722046, 206.448166, 83.994476, 140.02732849121), canRotate = true, cameraType = "blackwhite", type = "General Stores", name = "Los Santos FreeWay", camera = 3},
    {location = vector4(1435.146484, 713.986389, 82.519417, 138.47076416016), canRotate = true, cameraType = "blackwhite", type = "General Stores", name = "Los Santos FreeWay", camera = 4},
    {location = vector4(2020.052002, 2575.811523, 58.243885, 135.29922485352), canRotate = true, cameraType = "blackwhite", type = "General Stores", name = "Los Santos FreeWay", camera = 5},
    {location = vector4(2423.639648, 2882.013184, 44.444698, 105.21105957031), canRotate = true, cameraType = "blackwhite", type = "General Stores", name = "Los Santos FreeWay", camera = 6},
    
    --{location = vector4(1045.549927, -3207.323486, -38.0, 24.10719299316406), canRotate = true, cameraType = "highquality", type = "General Stores", name = "Weed Laboratoire", camera = 1},
    --{location = vector4(1062.288452, -3208.261719, -38.0, 16.04961967468261), canRotate = true, cameraType = "highquality", type = "General Stores", name = "Weed Laboratoire", camera = 2},
    --{location = vector4(1059.640625, -3181.274902, -36.688320, 247.58535766601565), canRotate = true, cameraType = "highquality", type = "General Stores", name = "Weed Laboratoire", camera = 3},
    -- --{location = vector4(1435.146484, 713.986389, 82.519417, 138.47076416016), canRotate = true, cameraType = "highquality", type = "General Stores", name = "Weed Laboratoire", camera = 4},
    
    {location = vector4(-319.986908, -1354.322876, 33.180981-2, 127.72254943847656), canRotate = true, cameraType = "highquality", type = "General Stores", name = "Weed Laboratoire", camera = 1},
    {location = vector4(-321.693420, -1351.585205, 26.802164-2, 299.6455993652344), canRotate = true, cameraType = "highquality", type = "General Stores", name = "Weed Laboratoire", camera = 2},
    {location = vector4(-299.333710, -1346.398071, 27.808867-2, 132.85379028320312), canRotate = true, cameraType = "highquality", type = "General Stores", name = "Weed Laboratoire", camera = 3},
    
    {location = vector4(-321.936798, -1352.642822, 29.818251-2, 247.7177886962891), canRotate = true, cameraType = "highquality", type = "General Stores", name = "Weed Laboratoire", camera = 4},
...
Config.Cameras.TimecycleTypes = {
    ["blackwhite"] = "CAMERA_secuirity",
    ["low"] = "scanline_cam_cheap",
    ["clear"] = "eyeINtheSKY",
