...
function UIMenuItem.New(Text, Description)
    _UIMenuItem = {
        ...
        SelectedSprite = Sprite.New("onestlagrrr", "gradient_nav", 0, 0, 431, 38),
        LeftBadge = { Sprite = Sprite.New("onestlagrrr", "", 0, 0, 40, 40), Badge = 0 },
        RightBadge = { Sprite = Sprite.New("onestlagrrr", "", 0, 0, 40, 40), Badge = 0 },
        Label = {
...
function UIMenuCheckboxItem.New(Text, Check, Description)
    local _UIMenuCheckboxItem = {
        ...
        CheckedSprite = Sprite.New("onestlagrrr", "shop_box_blank", 410, 95, 50, 50),
...
function UIMenuListItem.New(Text, Items, Index, Description)
    ...
    local _UIMenuListItem = {
        Base = UIMenuItem.New(Text or "", Description or ""),
        Items = Items,
        LeftArrow = Sprite.New("onestlagrrr", "arrowleft", 110, 105, 30, 30),
        RightArrow = Sprite.New("onestlagrrr", "arrowright", 280, 105, 30, 30),
...
function UIMenuSliderItem.New(Text, Items, Index, Description, Divider)
    ...
    local _UIMenuSliderItem = {
        ...
        LeftArrow = Sprite.New("onestlagrrrtu", "arrowleft", 0, 105, 15, 15),
        RightArrow = Sprite.New("onestlagrrrtu", "arrowright", 0, 105, 15, 15),
...
function UIMenuGridPanel.New(TopText, LeftText, RightText, BottomText)
    _UIMenuGridPanel = {
        ...
        Background = Sprite.New("onestlagrrr", "gradient_bgd", 0, 0, 431, 275),
...
function UIMenuColourPanel.New(Title, Colours)
    _UIMenuColourPanel = {
        ...
        Background = Sprite.New("onestlagrrr", "gradient_bgd", 0, 0, 431, 112),
        Bar = {},
        LeftArrow = Sprite.New("onestlagrrr", "arrowleft", 0, 0, 30, 30),
        RightArrow = Sprite.New("onestlagrrr", "arrowright", 0, 0, 30, 30),
...
function UIMenuPercentagePanel.New(MinText, MaxText)
    _UIMenuPercentagePanel = {
        ...
        Background = Sprite.New("onestlagrrr", "gradient_bgd", 0, 0, 431, 76),
...
function UIMenu.New(Title, Subtitle, X, Y, TxtDictionary, TxtName)
    ...
    if TxtDictionary ~= nil then TxtDictionary = tostring(TxtDictionary) or "onestlagrrr" else TxtDictionary = "onestlagrrr" end
    if TxtName ~= nil then TxtName = tostring(TxtName) or "interaction_bgd" else TxtName = "interaction_bgd" end
    local _UIMenu = {
        Logo = Sprite.New("onestlagrrr", "interaction_bgd", 0 + X, 0 + Y, 431, 107),
        Banner = nil,
        Title = UIResText.New(Title, 215 + X, 20 + Y, 1.15, Config.Animations.TitleColour.R, Config.Animations.TitleColour.G, Config.Animations.TitleColour.B, Config.Animations.TitleColour.A, Config.Animations.MenuFont, 1, nil, Config.Animations.TitleOutline),
        Subtitle = { ExtraY = 0 },
        WidthOffset = 0,
        Position = { X = X, Y = Y },
        ...
        Settings = {
            ...
            ControlDisablingEnabled = Config.Animations.DisableControls,
            Audio = {
    ...
    _UIMenu.ArrowSprite = Sprite.New("onestlagrrr", "shop_arrows_upanddown", 190 + _UIMenu.Position.X, 147 + 37 * (_UIMenu.Pagination.Total + 1) + _UIMenu.Position.Y - 37 + _UIMenu.Subtitle.ExtraY, 50, 50)
    ...
    _UIMenu.Description.Rectangle = Sprite.New("onestlagrrr", "gradient_bgd", _UIMenu.Position.X, 127, 431, 30)
    _UIMenu.Description.Text = UIResText.New("Description", _UIMenu.Position.X + 5, 125, 0.35)

    _UIMenu.Background = Sprite.New("onestlagrrr", "gradient_bgd", _UIMenu.Position.X, 144 + _UIMenu.Position.Y - 37 + _UIMenu.Subtitle.ExtraY, 290, 25)
