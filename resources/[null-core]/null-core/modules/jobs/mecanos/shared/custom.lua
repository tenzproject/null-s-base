...
-- Multiplicateur de prix selon la gamme du véhicule
-- Le prix final = prix de base de la pièce * multiplicateur du tier
-- Exemple : Aileron (1500$) sur un véhicule Sport (x1.8) = 2700$
cfg_custom.VehicleTiers = {
    { label = "Économique",  maxPrice = 30000,   multiplier = 0.8 },  -- Faggio, Panto, etc.
    { label = "Standard",    maxPrice = 60000,   multiplier = 1.0 },  -- Sultan, Kuruma, etc.
    { label = "Intermédiaire", maxPrice = 120000, multiplier = 1.3 },  -- Comet, Elegy, etc.
    { label = "Sport",       maxPrice = 300000,  multiplier = 1.8 },  -- Massacro, Schlagen, etc.
    { label = "Super",       maxPrice = 800000,  multiplier = 2.5 },  -- Zentorno, T20, etc.
    { label = "Prestige",    maxPrice = 9999999, multiplier = 3.5 },  -- Turismo R, Adder, etc.
}
...
-- Prix de base en $ (avant multiplicateur véhicule)
-- Prix final affiché = prix * multiplicateur du tier véhicule
...
cfg_custom.colorParts = {
	...
	wheelColorPrice = 400,             -- Couleur jantes
	primaryColorPrice = 600,           -- Couleur primaire
	secondaryColorPrice = 600,         -- Couleur secondaire
	pearlescentColorPrice = 800,       -- Nacré
	interiorColorPrice = 500,          -- Couleur intérieur
	customPrimaryColorPrice = 1200,    -- Couleur primaire custom RGB
	customSecondaryColorPrice = 1200,  -- Couleur secondaire custom RGB
	primaryPaintFinishPrice = 600,     -- Finition primaire
	secondaryPaintFinishPrice = 600    -- Finition secondaire
}
...
cfg_custom.neons = {
	[1] = {
		mod = 'leftNeon',
		label = _U('leftNeon'),
		price = 750            -- Néon gauche
	},
	[2] = {
		mod = 'rightNeon',
		label = _U('rightNeon'),
		price = 750            -- Néon droit
	},
	[3] = {
		mod = 'frontNeon',
		label = _U('frontNeon'),
		price = 750            -- Néon avant
	},
	[4] = {
		mod = 'backNeon',
		label = _U('backNeon'),
		price = 750            -- Néon arrière
	},
	[5] = {
		label = 'Couleur néon',
		mod = 'neonColor',
		mod1 = 'neonEnabled',
		price = 300            -- Couleur néon
	}
}
...
cfg_custom.upgrades = {
	[1]	= {
		...
		items = {
			label = {},
			price = { 0, 3000, 5000, 8000, 12000, 18000 }  -- Moteur Niv.1-5
		}
	},
	[2]	= {
		mod = 'modTransmission',
		...
		items = {
			label = {},
			price = { 0, 1500, 2500, 4000, 6000, 8000 }    -- Transmission Niv.1-5
		}
	},
	[3]	= {
		mod = 'modBrakes',
		...
		items = {
			label = {},
			price = { 0, 2000, 3500, 5000, 7000, 9000, 12000 } -- Freins Niv.1-6
		}
	},
	[4]	= {
		mod = 'modSuspension',
		...
		items = {
			label = {},
			price = { 0, 1500, 2500, 3500, 5000, 7000, 9000 } -- Suspension Niv.1-6
		}
	},
	[5]	= {
		mod = 'modTurbo',
