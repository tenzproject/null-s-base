...
Config.PMMS.defaultModel = Config.PMMS.isRDR and `p_phonograph01x` or `prop_boombox_01`
...
--
Config.PMMS.defaultMediaPlayers = {
	--[[
	{
...
Config.PMMS.defaultMediaPlayerSpawnDistance = Config.PMMS.maxRange + 10.0

-- DUI configuration
Config.PMMS.dui = {}

-- DUI page URL configuration
Config.PMMS.dui.urls = {}
...
Config.PMMS.audioVisualizations = {
	["bars"] = {
		name = "Bars"
	},
	["bars blocks"] = {
