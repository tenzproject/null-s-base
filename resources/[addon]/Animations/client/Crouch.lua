...
local function CrouchThread()
    CreateThread(function()
        ...
        while isCrouched do
            ...
            if Config.Animations.FpsMode == true then
...
local function CrouchKeyPressed()
    ...
    if Config.Animations.CrouchOverride then
...
-- Commands & KeyMapping --
if Config.Animations.CrouchEnabled then
    if Config.Animations.CrouchKeybindEnabled then
        RegisterKeyMapping('+crouch', "Crouch", "keyboard", Config.Animations.CrouchKeybind)
...
if Config.Animations.CrawlEnabled then
    if Config.Animations.CrawlKeybindEnabled then
        RegisterKeyMapping('crawl', "Crawl", "keyboard", Config.Animations.CrawlKeybind)
    end
