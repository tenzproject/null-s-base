...
-- ORIGINAL CREATOR DISCORD: https://discord.gg/qvFmwj2a2T

-- Shared
Config.Computer.Framework = "esx" -- esx/qbcore

Config.Computer.Locale = "FR" -- EN/FR/ES/DA/DE

Config.Computer.UseItem = "laptop" -- set the item that will be used to display the interface (to disable it, let it empty)

Config.Computer.DataHeists = {
    Enabled = false,
...
Config.Computer.ItemsList = {
    ...
    ["weed-seed-female"] = {
        ...
        label = "Graine femelle de Weed",
        price = 6,
        type = "item"
    },
    ["weed-seed-male"] = {
        name = "weed-seed-male",
        label = "Graine male de Weed",
        price = 6,
        type = "item"
    },
    ["drugs_scissors"] = {
        name = "drugs_scissors",
        label = "Ciseaux de jardinage",
        price = 25,
        type = "item"
    },
    ["empty_pooch"] = {
    ...
    ["phosphorus-meth"] = {
        name = "phosphorus-meth",
        label = "Phosphore rouge (Meth)",
        price = 45,
        type = "item"
    },
    ["solvant-meth"] = {
...
if IsDuplicityVersion() then
    ...
    Config.Computer.LaptopInVehicle = true 

    Config.Computer.UseProps = { -- list of props
    ...
    Config.Computer.TargetSystem = false -- if true then you must have ox_target or qb-target, if false prop interactions will be based on a zone check
    Config.Computer.TargetType = "ox" -- "ox"/"qb" for ox_target or qb-target

    Config.Computer.UsablePositions = { -- positions where players can open a computer free to use
