-- @todo: a refaire entierement.
--[[ xp system
local RockstarRanks = {1100, 2100, 3800, 6100, 9500, 12500, 16000, 19800, 24000, 28500, 33400, 38700, 44200, 50200,56400, 63000, 69900, 77100, 84700, 92500, 100700, 109200, 118000, 127100, 136500, 146200, 156200,166500, 177100, 188000, 199200, 210700, 222400, 234500, 246800, 259400, 272300, 285500, 299000,312700, 326800, 341000, 355600, 370500, 385600, 401000, 416600, 432600, 448800, 465200, 482000,499000, 516300, 533800, 551600, 569600, 588000, 606500, 625400, 644500, 663800, 683400, 703300,723400, 743800, 764500, 785400, 806500, 827900, 849600, 871500, 893600, 916000, 938700, 961600,984700, 1008100, 1031800, 1055700, 1079800, 1104200, 1128800, 1153700, 1178800, 1204200, 1229800,1255600, 1281700, 1308100, 1334600, 1361400, 1388500, 1415800, 1443300, 1471100, 1499100, 1527300, 1555800, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 1584350, 90000000}
XNL_UseRedBarWhenLosingXP = true
XNL_MaxPlayerLevel = 999
XNL_EnableZKeyForRankbar = true
XNL_CurrentPlayerXP = 0
RegisterCommand("addxp", function(source, args)
	if (ESX.GetPlayerData()['group']) == "fondateur" or (ESX.GetPlayerData()['group']) == "responsable" or (ESX.GetPlayerData()['group']) == "superadmin" then
        local CurrentXP = tonumber(XNL_CurrentPlayerXP)
		local FirstParam = args[1]
		TestNR = tonumber(FirstParam)
        CurrentXPWithAddedXP = tonumber(XNL_CurrentPlayerXP + TestNR)
		XNL_AddPlayerXP(TestNR)
        TriggerServerEvent("XNL_SAVE:3ktWUdgNkuyy6v7WLR7KBX",CurrentLevel,CurrentXPWithAddedXP)
	end
end)

AddEventHandler("onResourceStop", function(resource)
    if resource == GetCurrentResourceName() then
		XNL_AddPlayerXP(XNL_CurrentPlayerXP)
        TriggerServerEvent("XNL_SAVE:3ktWUdgNkuyy6v7WLR7KBX",nil,tonumber(XNL_CurrentPlayerXP))
    end
end)
...
AddEventHandler("onResourceStart", function()
    if GetCurrentResourceName() then
        local CurrentXP = tonumber(XNL_CurrentPlayerXP)
        --TriggerServerEvent("XNL_SAVE:3ktWUdgNkuyy6v7WLR7KBX",CurrentXP,CurrentXP)
    end
end)
...
function CreateRankBar(XP_StartLimit_RankBar, XP_EndLimit_RankBar, playersPreviousXP, playersCurrentXP,
    ...
    RankBarColor = tonumber(ESX.Config("FivemHudIndex"))
...
Citizen.CreateThread(function()
    while true do
        ...
        CurrentXPWithAddedXP = tonumber(XNL_CurrentPlayerXP + TestNR)
		XNL_AddPlayerXP(TestNR)
        ESX.ShowAdvancedNotification(ESX.Config("serverColor")..ESX.Config("serverName"), "Levels", "Vous avez gagner 1000~s~ XP!\nMerci de votre activité sur le serveur.","DIA_TANNOY", 7)
        TriggerServerEvent("XNL_SAVE:3ktWUdgNkuyy6v7WLR7KBX",CurrentLevel,CurrentXPWithAddedXP)
    end
end)
...
Citizen.CreateThread(function()
    ...
    while true do
        if XNL_CurrentPlayerXP < 6100 then
            ...
            savexp = XNL_CurrentPlayerXP
            Wait(10000)
        end
		if XNL_CurrentPlayerXP < 6100 then
            local newWeap = GetSelectedPedWeapon(PlayerPedId())
            --NetworkSetFriendlyFireOption(false)
            if newWeap ~= mainhash then
                SetCurrentPedWeapon(plyPed, `WEAPON_UNARMED`, true)
                --ESX.ShowNotification("Vous n'avez pas le niveau~s~ requis ("..ESX.Config("serverColor").."5~s~)")
            end
            ...
            if savexp ~= XNL_CurrentPlayerXP and XNL_CurrentPlayerXP < 6500 then
                --NetworkSetFriendlyFireOption(true)
                ESX.ShowNotification("Vous avez désormais le niveau~s~ nécéssaire")
            end
		end
    end
end)
