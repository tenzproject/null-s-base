...
local volumes = {
	['radio'] = tonumber(GetConvar('voice_defaultVolume', '0.5')),
	['phone'] = tonumber(GetConvar('voice_defaultVolume', '0.5')),
}
...
RegisterNetEvent("pma-voice:changeMute", function(bool, cb)
	playerMuted = bool
